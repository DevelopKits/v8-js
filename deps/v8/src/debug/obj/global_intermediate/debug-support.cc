...
/*
 * This file is generated by ..\tools\gen-postmortem-metadata.py.  Do not edit directly.
 */
...
int v8dbg_class_PropertyArray__length__SMI = PropertyArray::kLengthOffset;
...
int v8dbg_class_Module__script__Script = Module::kScriptOffset;
int v8dbg_class_Module__exception__Object = Module::kExceptionOffset;
int v8dbg_class_Module__status__SMI = Module::kStatusOffset;
int v8dbg_class_Module__dfs_index__SMI = Module::kDfsIndexOffset;
int v8dbg_class_Module__dfs_ancestor_index__SMI = Module::kDfsAncestorIndexOffset;
